...
echo "> Starting the memcache app on port 5000"
gunicorn --bind 0.0.0.0:5000 --timeout 0 --workers=1 --threads=2 --capture-output --log-level debug run_memcacheapp:webapp &> memcacheapp_log.txt &
